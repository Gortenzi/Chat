...
exports.renderOtherMessage = renderOtherMessage;
...
function sendMyMessage() {
  ...
  var txt = templ.content.querySelector('.message-text__my>span');
  var time = templ.content.querySelector('.message-time__my');
...
function renderOtherMessage(response) {
  for (var i = 0; i < response.messages.length; i++) {
    ...
    var chat = document.querySelector('.middle-chat');
    var templ = document.querySelector('#templ-other');
...
var getRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(method, url) {
    ...
    }, _callee, null, [[4, 15, 18, 22], [24, 35, 38, 42]]);
  }));
...
},{"./template.js":"template.js"}],"modal.js":[function(require,module,exports) {
"use strict";
...
_request.UI_REQUEST.FORM_INPUT.addEventListener('submit', function () {
  var body = {
    email: _request.UI_REQUEST.INPUT_EMAIL.value
  };
  (0, _request.getRequest)('POST', _request.UI_REQUEST.URL_POST, body);
}); // PATCH request


_request.UI_REQUEST.FORM_FOR_CODE.addEventListener('submit', function () {
  ...
  var body = {
    name: _request.UI_REQUEST.USER_NAME.value
  };
